  ...
  en: {
    ...
    portfolio: {
      ...
      items: {
        ...
        'hyperion-org': { client: 'Cybersecurity · Logo Design', title: 'Hyperion Cybernetical Emblem' },
        'zephyr-marine': { client: 'Maritime · Logo Design', title: 'Zephyr Wind & Wave Logomark' },
        ...
        'zenith-esports': { client: 'Gaming · Visual Identity', title: 'Zenith Esports Core Brand System' },
        'orion-home': { client: 'IoT · Visual Identity', title: 'Orion Smart Home Guidelines' },
        'gaia-skincare': { client: 'Wellness · Visual Identity', title: 'Gaia Botanical Brand Identity' },
        ...
        'chronos-watch': { client: 'Luxury · Collateral & Print', title: 'Chronos Premium Watch Box Edition' },
        'astral-botanicals': { client: 'Beverage · Collateral & Print', title: 'Astral Gin Botanical Craft Cylinder' },
        ...
        'polaris-pulse': { client: 'Entertainment · Logo Motion', title: 'Polaris Neon Pulse Identity Reveal' },
        'vektor-cybernetics': { client: 'Tech · Logo Motion', title: 'Vektor Cybernetic Reveal Loop' },
        'solis-glitch': { client: 'Media · Logo Motion', title: 'Solis Glitch Branding Signature' },
      }
    },
    testimonials: {
  ...
  id: {
    ...
    portfolio: {
      ...
      items: {
        ...
        'hyperion-org': { client: 'Keamanan Siber · Desain Logo', title: 'Emblem Siber Terenkripsi Hyperion' },
        'zephyr-marine': { client: 'Sektor Kelautan · Desain Logo', title: 'Logogram Angin & Ombak Zephyr' },
        ...
        'zenith-esports': { client: 'Sektor Game · Identitas Visual', title: 'Sistem Identitas Utama Zenith Esports' },
        'orion-home': { client: 'IoT · Identitas Visual', title: 'Panduan Identitas Rumah Pintar Orion' },
        'gaia-skincare': { client: 'Kesehatan & Kecantikan · Identitas Visual', title: 'Identitas Brand Botani Alami Gaia' },
        ...
        'chronos-watch': { client: 'Gaya Hidup Mewah · Desain Cetak & Kemasan', title: 'Kotak Kemasan Jam Tangan Premium Chronos' },
        'astral-botanicals': { client: 'Sektor Minuman · Desain Cetak & Kemasan', title: 'Tabung Kerajinan Craft Gin Astral' },
        ...
        'polaris-pulse': { client: 'Industri Hiburan · Animasi Logo', title: 'Pembukaan Identitas Lintasan Neon Polaris' },
        'vektor-cybernetics': { client: 'Sektor Teknologi · Animasi Logo', title: 'Loop Pembuka Cybernetic Vektor' },
        'solis-glitch': { client: 'Industri Media · Animasi Logo', title: 'Signature Animasi Glitch Solis' },
      }
    },
    testimonials: {
